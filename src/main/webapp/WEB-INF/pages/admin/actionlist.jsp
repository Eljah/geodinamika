...
<div class="col-sm-10">
    ...
    <form method="get" action="${ctx}/admin/actionlist" id="searchForm" class="form-inline">
    ...
    <div id="actions" class="btn-group">
        <a class="btn btn-primary" href="<c:url value='/admin/actionFromSteps?method=Add&from=list'/>">
    ...
    <display:table name="actionlist" cellspacing="0" cellpadding="0" requestURI=""
        ...
        <display:column property="id" escapeXml="true" sortable="true" titleKey="task.id" style="width: 25%"
                        url="/admin/actionFromSteps?from=list" paramId="id" paramProperty="id"/>
        <display:column property="description" escapeXml="true" sortable="true" titleKey="action.description" style="width: 25%" paramId="id" paramProperty="id"/>
        <display:column property="actionStepsDescription" escapeXml="true" sortable="true" titleKey="action.steps" style="width: 25%"  autolink="true"
                />
