...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see geodinamika.service.impl.PasswordTokenManager#generateRecoveryToken(geodinamika.model.User)
     */
    @Override
    ...
    /**
     * @see geodinamika.service.impl.PasswordTokenManager#isRecoveryTokenValid(geodinamika.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see geodinamika.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
