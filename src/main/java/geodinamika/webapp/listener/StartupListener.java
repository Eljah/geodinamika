package geodinamika.webapp.listener;
...
public class StartupListener implements ServletContextListener {
    ...
    public static void setupContext(ServletContext context) {
        ...
        context.setAttribute(Constants.AVAILABLE_STEPS, mgr.getAllSteps());
        context.setAttribute(Constants.AVAILABLE_ACTIONS, mgr.getAllActions());
